...
版本/Version              : V0.2.5 （测试版为发布版版本号前加0.）
团队/Team                 : ThreeBugs
作者/Author               : EmberOfBag
日期/Date（YYYYMMDD）     : 20200624
程序目的/Purpose : 
...
#define LoopDelay 50          // 在loop最后，延迟的时间 \
...
void loop()
{
    ...
    if (SleepMark)
    {
        ...
        ESP.deepSleep(SleepTime); //此处有4s,4s后唤醒
    }
    delay(LoopDelay);
}
